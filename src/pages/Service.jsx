...
const Service = () => {
  ...
  return (
    <section className="bg-gray-950  " id="services">
      ...
      >
        <path
          d="M 0,400 L 0,100 C 75.40364136035728,116.17657162487117 150.80728272071457,132.35314324974235 227,134 C 303.19271727928543,135.64685675025765 380.1745104774991,122.76399862590176 438,111 C 495.8254895225009,99.23600137409824 534.4946753692889,88.59086224665062 600,99 C 665.5053246307111,109.40913775334938 757.8467880453453,140.87255238749572 839,138 C 920.1532119546547,135.12744761250428 990.1181724493301,97.91892820336653 1061,79 C 1131.8818275506699,60.081071796633466 1203.6805221573343,59.451734799038135 1267,66 C 1330.3194778426657,72.54826520096186 1385.159738921333,86.27413260048093 1440,100 L 1440,400 L 0,400 Z"
          stroke="none"
          stroke-width="0"
          fill="#111828"
          fill-opacity="0.53"
      ...
      >
        <defs>
          <linearGradient id="gradient" x1="0%" y1="50%" x2="100%" y2="50%">
            <stop offset="5%" stop-color="#0C1421"></stop>
            <stop offset="25%" stop-color="#0C1421"></stop>
          </linearGradient>
        </defs>
        <path
